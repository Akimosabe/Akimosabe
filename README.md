...
- Test Case Design, Checklists, Bug Reporting  
- API Testing with **Postman** (REST, JSON, HTTP)  
- Web Testing via **Chrome DevTools**  
- TestOps, SQL (queries), GitHub CI/CD basics  
...
💼 **LinkedIn:** [linkedin.com/in/akimosabe](https://www.linkedin.com/in/akimosabe)
